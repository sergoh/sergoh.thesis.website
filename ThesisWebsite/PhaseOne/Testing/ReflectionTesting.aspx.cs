...
public partial class ReflectionTesting : Page
{
    ...
    protected void btnTest_Click(object sender, EventArgs e)
    {
        ...
        if (parameter != "")
        {
            try
            {
                lblResult.Text = service.WsReflectionTesting(txtWSDL.Text, lbMethods.SelectedItem.Text, "Soap", parameters).ToString();
